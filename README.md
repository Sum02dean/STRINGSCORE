...
### Example Results
Running several models on E-coli shows high performance across all models - XGboost outperforms the other models.
![Example results](configs/string_score_example_results.jpg)
